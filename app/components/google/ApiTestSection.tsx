...
import { TestResults } from "../../types/googleTypes";
...
function TestResultsDisplay({ testResults }: { testResults: TestResults }) {
  return (
    <div
          ...
          <div className="flex justify-between items-center">
            ...
            <span
              className={`font-medium ${
                testResults.billingEnabled ? "text-green-700" : "text-amber-600"
              }`}
            >
              {testResults.billingEnabled ? "Enabled" : "Check billing setup"}
            </span>
          </div>
